...
class ContractAdmin(admin.ModelAdmin):
    ...
    list_display = (
    'contract_id', 'client', 'sales_contact', 'dateCreated', 'status', 'amount', 'paymentDue')
...
class EventAdmin(admin.ModelAdmin):
    ...
    search_fields = ('eventStatus__client__first_name', 'eventStatus__client__last_name',
                     'support_contact__username')
